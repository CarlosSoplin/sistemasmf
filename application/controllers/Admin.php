    ...
    function dashboard()
    {
     ...
     function profesor($param1 = '', $param2 = '', $param3 = '')
     {
         ...
         if ($param1 == 'create') {
             ...
             $this->session->set_tempdata('flash_message' , 'Datos añadidos satisfactoriamente');
             $this->email_model->account_opening_email('profesor', $data['email']); //Enviar EMAIL
              } else {
                 $this->session->set_tempdata('flash_message_error' , 'Uso de la cuenta de correo electrónico');
             }
         ...
         if ($param1 == 'actualizar') {
             ...
             $this->session->set_tempdata('flash_message' , 'Datos Actualizados');
             redirect(base_url() . 'index.php?admin/profesor/', 'refresh');
         ...
         if ($param1 == 'cambiar_password') {
             ...
             $this->db->update('profesor', array(
                 ...
                 $this->session->set_tempdata('flash_message', 'Actualizar contraseña');
             } else {
                 $this->session->set_tempdata('flash_message_error', 'Falta de coincidencia de contraseña');
             }
             redirect(base_url() . 'index.php?admin/profesor/', 'refresh');
         }
         if ($param1 == 'eliminar') {
             ...
             $this->session->set_tempdata('flash_message' , 'Datos Eliminados');
             redirect(base_url() . 'index.php?admin/profesor/', 'refresh');
         }
 ...
 function get_valid_email()
    {
        $email = $_POST["email"];
            ...
            if ($stu_vemail == null && $tea_vemail == null && $par_vemail == null) {
				...
				$this->session->set_tempdata('flash_message_error', 'Esta cuenta de correo electrónico ya se utiliza');
                return false;
            }
    }
...
function estudiantes($param1 = '', $param2 = '', $param3 = '')
{
    ...
    if ($param1 == 'cambiar_password') {
        ...
        $this->db->update('estudiante', array(
            ...
            $this->session->set_tempdata('flash_message', 'Contraseña Actualizada');
        } else {
            $this->session->set_tempdata('flash_message_error', 'Falta coincidencia de contraseña');
        }
        redirect(base_url() . 'index.php?admin/estudiante/' . $param3, 'refresh');
    }
   ...
   function padres($param1 = '', $param2 = '', $param3 = '')
   {
       ...
       if ($param1 == 'edit') {
           ...
           $this->session->set_tempdata('flash_message' , get_phrase('Datos Actualizados'));
           redirect(base_url() . 'index.php?admin/padres/', 'refresh');
       }
       if ($param1 == 'cambiar_password') {
           $data['password']         = sha1($this->input->post('new_password'));
           ...
           $this->db->update('padres', array(
               ...
               $this->session->set_tempdata('flash_message', 'Contraseña Actualizado');
           } else {
               $this->session->set_tempdata('flash_message_error', 'La Contraseña no coinciden');
           }
           redirect(base_url() . 'index.php?admin/padres/', 'refresh');
       }
       if ($param1 == 'eliminar') {
...
function tema($param1 = '', $param2 = '' , $param3 = '')
{
    ...
    if ($param1 == 'create') {
        ...
        $this->session->set_tempdata('flash_message' , get_phrase('Datos Añadidos Satisfactoriamente'));
...
function actualizar_asistencia($class_id = '' , $section_id = '' , $timestamp = '')
    {
        ...
        $this->session->set_tempdata('flash_message' , 'Asistencia Guardada');
...
function factura($param1 = '', $param2 = '', $param3 = '')
{
    ...
    if ($param1 == 'completar_pago') {
        ...
        $this->session->set_tempdata('flash_message' , 'Pago Exitoso');
        redirect(base_url() . 'index.php?admin/ingreso/', 'refresh');
    }
...
function biblioteca($param1 = '', $param2 = '', $param3 = '')
{
 ...
 function lista_examen($param1 = '', $param2 = '' , $param3 = '')
 {
  ...
  function grado($param1 = '', $param2 = '')
  {
   ...
   function actualizar_calificacion($examen_id = '' , $clase_id = '' , $seccion_id = '' , $tema_id = '')
   {
       ...
       $this->session->set_tempdata('flash_message' , 'Calificación Actualizada');
   ...
   function calificacion_reporte($clase_id = '' , $examen_id = '') {
       ...
       if ($this->input->post('operacion') == 'seleccion') {
           ...
           if ($page_data['examen_id'] > 0 && $page_data['clase_id'] > 0) {
               ...
               $this->session->set_tempdata('mark_message', 'Elige clase y examen');
 ...
 function mensaje($param1 = 'mensaje_inicio', $param2 = '', $param3 = '') {
    ...
    if ($param1 == 'enviar_nuevo') {
        ...
        $this->session->set_tempdata('flash_message', 'Mensaje Enviado');
...
function anuncio($param1 = '', $param2 = '', $param3 = '')
{
 ...
 function usuario_plan_estudio()
 {
     ...
     $this->session->set_tempdata('flash_message' , 'Archivo Subido con Exito');
 ...
 function manage_profile($param1 = '', $param2 = '', $param3 = '')
 {
     ...
     if ($param1 == 'update_profile_info') {
         ...
         $this->session->set_tempdata('flash_message', get_phrase('account_updated'));
     ...
     if ($param1 == 'change_password') {
         ...
         if ($current_password == $data['password'] && $data['new_password'] == $data['confirm_new_password']) {
             ...
             $this->session->set_tempdata('flash_message', get_phrase('password_updated'));
         } else {
             $this->session->set_tempdata('flash_message_error', get_phrase('password_mismatch'));
         }
         redirect(base_url() . 'index.php?admin/manage_profile/', 'refresh');
     }
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_tempdata('flash_message' , get_phrase('data_updated')); 
            redirect(base_url() . 'index.php?admin/system_settings/', 'refresh');
		
        }
        if ($param1 == 'upload_logo') {
            move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/logo.png');
            $this->session->set_tempdata('flash_message', get_phrase('settings_updated'));
            redirect(base_url() . 'index.php?admin/system_settings/', 'refresh');
        }
        if ($param1 == 'change_skin') {
            ...
            $this->session->set_tempdata('flash_message' , get_phrase('theme_selected')); 
            redirect(base_url() . 'index.php?admin/system_settings/', 'refresh'); 
    ...
    function change_session()
    {
        ...
        $this->db->where('type' , 'running_year');
        $this->db->update('settings' , $data);
        $this->session->set_tempdata('flash_message' , get_phrase('session_changed')); 
        redirect(base_url() . 'index.php?admin/dashboard/', 'refresh'); 
    }
