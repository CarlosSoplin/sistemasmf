...
<!-- Pnotify Notifications JS -->
		...
		<!-- SHOW PNOTIFIVATION -->
		<?php if ($this->session->tempdata('flash_message') != ""):?>
		<script type="text/javascript">
			new PNotify({
				title: 'Successful',
				text: '<?php echo $this->session->tempdata("flash_message");?>',
				shadow: true,
				type: 'success',
				buttons: {
				sticker: false
		...
		<?php if ($this->session->tempdata('flash_message_error') != ""):?>
		<script type="text/javascript">
			new PNotify({
				title: 'Error',
				text: '<?php echo $this->session->tempdata("flash_message_error");?>',
				shadow: true,
				type: 'error',
				buttons: {
				sticker: false
