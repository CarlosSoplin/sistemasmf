			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<!-- ADMIN BOORAR LINK -->
						<a href="#" class="btn btn-xs btn-danger" data-placement="top" data-toggle="tooltip" data-original-title="Borrar" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/registrar_admin/eliminar/<?php echo $row['admin_id'];?>');">
