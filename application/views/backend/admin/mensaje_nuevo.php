...
<?php echo form_open(base_url() . 'index.php?admin/mensaje/enviar_nuevo/', array( 'id' => 'form', 'enctype' => 'multipart/form-data')); ?>
	<div class="panel">
		...
		<div class="compose">
			<select class="form-control" data-plugin-selectTwo data-width="100%" name="receptor" required title="Seleccione un Usuario">
				<option value="">
					Seleccione Usuario
				</option>
			...
			<div class="compose">
				<textarea name="mensaje" class="form-control" placeholder="Escribir tu Mensaje" required title="Debes escribir un mensaje para enviar" aria-required="true" rows="10" style="height: 320px;"></textarea>
			</div>
		</div>
